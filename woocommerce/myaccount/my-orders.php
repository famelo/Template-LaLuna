	...
	<table class="shop_table my_account_orders">
		...
		<thead>
			<tr>
				...
				<th class="order-date hidden-xs"><span class="nobr"><?php _e( 'Date', 'woocommerce' ); ?></span></th>
				<th class="order-status"><span class="nobr"><?php _e( 'Status', 'woocommerce' ); ?></span></th>
				<th class="order-total hidden-xs"><span class="nobr"><?php _e( 'Total', 'woocommerce' ); ?></span></th>
