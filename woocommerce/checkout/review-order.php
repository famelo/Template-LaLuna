	...
	<div id="payment">
		...
		<div class="form-row place-order">
			...
			<?php if (woocommerce_get_page_id('terms')>0) : ?>
				<div class="checkbox">
				  <label for="terms">
				    <input type="checkbox" name="terms" <?php checked( isset( $_POST['terms'] ), true ); ?> id="terms" />
				    <?php _e( 'I have read and accept the', 'woocommerce' ); ?> <a href="<?php echo esc_url( get_permalink(woocommerce_get_page_id('terms')) ); ?>" target="_blank"><?php _e( 'terms &amp; conditions', 'woocommerce' ); ?></a>
				  </label>
				</div>
			<?php endif; ?>
			...
			echo apply_filters('woocommerce_order_button_html', '<input type="submit" class="btn btn-success btn-lg" name="woocommerce_checkout_place_order" id="place_order" value="' . $order_button_text . '" />' );
			?>
